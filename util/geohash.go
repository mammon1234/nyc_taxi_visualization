...
// Create a geohash with 10 positions based on LatLng coordinates
func Encode(latitude, longitude float64) string {
	return EncodeWithPrecision(latitude, longitude, 10)
}
...
//func main()  {
//	geohash := Encode(41.8781139, -87.6297872)
//	fmt.Println(geohash)
//	fmt.Println(Decode(geohash))
//}
